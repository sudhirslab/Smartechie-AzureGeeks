...
{
    private const string topicEndpoint = "https://pubsubevents.eastus-1.eventgrid.azure.net/api/events";
    ...
    private const string topicKey = "rJD3zNANKWMAWq8TqtBUeWG2THPOjbz1x2IppTsQ4sYR0oPyDTLxJQQJ99AHACYeBjFXJ3w3AAABAZEGPUH4";
    ...
    {   
        ...
        EventGridEvent secondEvent = new EventGridEvent(
            ...
            data: new
            {
                ...
                Address = "456 College Street, Cupertino, CA 98107"
            }
        );
