...
namespace MessagePublisher
{
    public class Program
    {
        ...
        private const string serviceBusConnectionString = "Endpoint=sb://srvcbus.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=dbhjdsbdkjsdbsdgdhg+ASbIGXzUM=";

        /* To create a string constant named "queueName" with a value
           of "messagequeue", matching the name of the Service Bus queue.*/
        private const string queueName = "my-msg-queue";
